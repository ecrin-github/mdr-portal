(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('@angular/router'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-google-analytics', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common', 'rxjs', '@angular/router', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global['ngx-google-analytics'] = {}, global.ng.core, global.ng.common, global.rxjs, global.ng.router, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,exports, i0, i2, rxjs, router, operators) { 'use strict';
...
GaEventCategoryDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: GaEventCategoryDirective, selectors: [["", "gaEvent", "", "gaCategory", ""], ["", "gaCategory", ""]], inputs: { gaCategory: "gaCategory" }, exportAs: ["gaCategory"] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(GaEventCategoryDirective, [{
        type: i0.Directive,
        args: [{
...
GoogleAnalyticsService.ɵfac = function GoogleAnalyticsService_Factory(t) { return new (t || GoogleAnalyticsService)(ɵngcc0.ɵɵinject(NGX_GOOGLE_ANALYTICS_SETTINGS_TOKEN), ɵngcc0.ɵɵinject(i2.DOCUMENT), ɵngcc0.ɵɵinject(NGX_GTAG_FN)); };
...
NgxGoogleAnalyticsRouterModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgxGoogleAnalyticsRouterModule });
NgxGoogleAnalyticsRouterModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgxGoogleAnalyticsRouterModule_Factory(t) { return new (t || NgxGoogleAnalyticsRouterModule)(); }, providers: [
        NGX_GOOGLE_ANALYTICS_ROUTER_INITIALIZER_PROVIDER
    ], imports: [[
            i2.CommonModule,
            NgxGoogleAnalyticsModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxGoogleAnalyticsRouterModule, { imports: [ɵngcc1.CommonModule, NgxGoogleAnalyticsModule] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxGoogleAnalyticsRouterModule, [{
        type: i0.NgModule,
        args: [{
                imports: [
                    i2.CommonModule,
