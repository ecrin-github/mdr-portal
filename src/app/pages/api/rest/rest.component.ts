...
export class RestComponent implements OnInit {
  ...
  onSearchTypeChange(value: string) {
    ...
    if (this.selectedOption === 'study-characteristics') {
      ...
      this.apiUrl = environment.hostname + environment.esQueryBaseUrl + environment.studyCharacteristicsUrl;
    } else if (this.selectedOption === 'specific-study') {
      this.query = specificStudyQuery;
      this.apiUrl = environment.hostname + environment.esQueryBaseUrl + environment.specificStudyUrl;
    } else if (this.selectedOption === 'via-published-paper') {
      this.query = viaPublishedPaperQuery;
      this.apiUrl = environment.hostname + environment.esQueryBaseUrl + environment.viaPublishedPaperUrl;
    } else if (this.selectedOption === 'by-study-id') {
      this.query = selectedStudyQuery;
      this.apiUrl = environment.hostname + environment.esQueryBaseUrl + environment.studyIdUrl;
    } else {
      this.error = true;
